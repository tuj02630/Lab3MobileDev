...
class ImageActivity : AppCompatActivity() {
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        val largeImageView = findViewById<ImageView>(R.id.displayImageView)
        ...
        adapter.onItemClick = { imageOb ->
            ...
            descriptionTextView.setText(imageOb.description);
            largeImageView.setImageResource(imageOb.resourceId);
